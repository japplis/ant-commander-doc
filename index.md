...
- Ant Commander Personal edition is a free file manager and is targeted at a personal usage
- Ant Commander Pro is a commercial software and targeted at a professional usage

This help focusses on Ant Commander Pro. [Ant Commander Personal](personal.md) is a subset of Ant Commander Pro. 
...
Powershell, Git bash, Cygwin, WSL2 will only show if they are installed on your computer and are in the _PATH_ environment variable.
...
Some actions can be disabled if the action is not available for the currently selected panel or currently location or if no files are selected.
The enabled actions are listed in the _Menu -> File -> Execute action_ (<kbd>F9</kbd>) action.
